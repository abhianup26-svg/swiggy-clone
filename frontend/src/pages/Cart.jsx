        ...
        <div style={styles.right}>
          <div style={styles.billCard}>
            ...
            <div style={styles.billRow}>
              ...
              <span style={styles.billValue}>₹{subtotal}</span>
            </div>
            <div style={styles.billRow}>
              <span style={styles.billLabel}>Delivery Fee</span>
              <span style={styles.billValue}>₹{deliveryFee}</span>
            </div>
            <div style={styles.billRow}>
              <span style={styles.billLabel}>Taxes (5%)</span>
              <span style={styles.billValue}>₹{taxes}</span>
            </div>

            <div style={styles.billDivider} />

            <div style={styles.billRow}>
              <span style={styles.billTotal}>Total</span>
              <span style={styles.billTotal}>₹{total}</span>
            </div>
            ...
            <p style={styles.safeText}>
              Payments coming soon — Cash on Delivery
            </p>
          </div>
        </div>
